...
new g_SmokePuff_SprId, c_ShellCustom, g_Sgd[3] //g_Event_Base, 
...
public plugin_init()
{
	...
	g_Sgd[0] = zp_register_extra_item("Magnum Drill", 10, ZP_TEAM_HUMAN)
...
{
	if(d == g_Sgd[0]) Get_Base(i, 0)
	else if(d == g_Sgd[1]) Get_Base(i, 1)
	else if(d == g_Sgd[2]) Get_Base(i, 2)
}
